...
这个定义是个非常抽象和晦涩的概念，其实就是讲了一个**搭建在类似以太坊的去中心化可编程平台（也叫「世界计算机」）上的网络应用平台**，可以看到和 Web 1.0、Web 2.0 并不是派生关系，而是从底层基础设施到应用层都做了彻底颠覆，说成 Web3 感觉是有点牵强的，更准确的说法应该是下一代互联网，我们下文均简称为**以太坊版 Web3**。
...
回过来看 Web3，从各种不同的 Web3 理解，有一个共识是比较容易达成一致，即 Web3 是让用户对个人数据拥有控制权。

而以太坊 Web3 是这种到底是以太坊的势能，还是以太坊是 Web3 的势能？

市值 = 总供应量（1900w） \* 交易价格（4w）

交易价格 = 可交易资金量 / 可交易供应量

交易额(27w 亿) = 交易价格（4w） _ 交易量（可交易供应量 _ 换手率）= 可交易资金量 \* 换手率
